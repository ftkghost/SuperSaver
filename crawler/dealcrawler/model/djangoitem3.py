...
class DjangoItem(Item, metaclass=DjangoItemMeta):
    """
    Python 3.x does not allow __metaclass__ defined as a class attribute.
    Ref: http://python-3-patterns-idioms-test.readthedocs.org/en/latest/Metaprogramming.html
    """
